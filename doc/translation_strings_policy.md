...
This document provides guidelines for internationalization of the Monicoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `monicoin_en.ts` remains unchanged.
