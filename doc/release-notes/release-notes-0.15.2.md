Monicoin Core version *0.15.2* is now available from:

  <https://monicoincore.org/bin/monicoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in monicoin-tx (TheBlueMatt)
