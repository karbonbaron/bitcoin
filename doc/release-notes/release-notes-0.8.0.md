Monicoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/monicoin/files/Monicoin/monicoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Monicoin
...
New/changed settings (command-line or monicoin.conf file)
--------------------------------------------------------
