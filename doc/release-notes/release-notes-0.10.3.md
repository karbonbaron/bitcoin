Monicoin Core version 0.10.3 is now available from:

  <https://monicoin.org/bin/monicoin-core-0.10.3/>
...
(see https://github.com/monicoin/monicoin/pull/6793, as well as the 0.11.0
