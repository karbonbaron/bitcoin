Monicoin Core version 0.9.4 is now available from:

  https://monicoin.org/bin/0.9.4/
...
this update is incompatible with the Monicoin system and could lead to consensus
forks.

Monicoin Core released binaries from https://monicoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~monicoin/+archive/ubuntu/monicoin
- A third-party or self-compiled Monicoin Core

upgrade to Monicoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
