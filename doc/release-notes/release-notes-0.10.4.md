Monicoin Core version 0.10.4 is now available from:

  <https://monicoin.org/bin/monicoin-core-0.10.4/>
...
- #6953 `43c2789` Split monicoin-tx into its own package
- #6953 `dfe0d4d` Include monicoin-tx binary on Debian/Ubuntu
