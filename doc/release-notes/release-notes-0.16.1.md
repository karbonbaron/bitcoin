Monicoin Core version 0.16.1 is now available from:

  <https://monicoincore.org/bin/monicoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting monicoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure monicoind processes are cleaned up when tests end (sdaftuar)
