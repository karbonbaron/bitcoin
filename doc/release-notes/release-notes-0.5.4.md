Monicoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/monicoin/files/Monicoin/monicoin-0.5.4/
...
http://gitorious.org/monicoin/monicoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Monicoin-Qt notifications under Growl 1.3.
Increase required age of Monicoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxMonicoin properly when installing Monicoin-Qt over it. (Windows)
