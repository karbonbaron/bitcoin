Download URL: https://sourceforge.net/projects/monicoin/files/Monicoin/monicoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 MC fee schedule (users still pay 0.01 MC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #monicoin00 - #monicoin99
