...
Monicoin Core version 0.19.1 is now available from:

  <https://monicoincore.org/bin/monicoin-core-0.19.1/>
...
From Monicoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Monicoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Monicoin Core does not yet change appearance when
...
- #17488 fix "monicoind already running" warnings on macOS (fanquake)
