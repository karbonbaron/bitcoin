Monicoin Core version 0.9.2.1 is now available from:

  https://monicoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 MC to 0.01 MC
...
- Fix "Start monicoin on system login"
