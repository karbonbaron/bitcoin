Monicoin Core version 0.13.2 is now available from:

  <https://monicoin.org/bin/monicoin-core-0.13.2/>
...
- #8908 `4a974b2` Update monicoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow monicoin-tx to create v2 transactions (btcdrak)
