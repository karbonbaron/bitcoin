...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Monicoin
else
  DOCKER_EXEC echo \> \$HOME/.monicoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/monicoin/monicoin/pull/18288#discussion_r433189350 for
  # details.
