...
class TestShell:
    """Wrapper Class for MonicoinTestFramework.

    The TestShell class extends the MonicoinTestFramework
    ...
    class __TestShell(MonicoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by MonicoinTestFramework child class.
            self.num_nodes = 1
