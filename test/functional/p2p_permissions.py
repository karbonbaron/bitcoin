...
class P2PPermissionsTests(MonicoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].monicoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].monicoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
