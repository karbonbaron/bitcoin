...
"""Verify that starting monicoin with -h works as expected."""

from test_framework.test_framework import MonicoinTestFramework
from test_framework.util import assert_equal

class HelpTest(MonicoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start monicoin with -h for help text")
        ...
        self.log.info("Start monicoin with -version for version information")
        ...
        self.log.info("Start monicoind with -fakearg to make sure it does not start")
