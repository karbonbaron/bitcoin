...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the MonicoinTestFramework
    pass


class ExampleTest(MonicoinTestFramework):
    # Each functional test is a subclass of the MonicoinTestFramework class.
    ...
    def custom_method(self):
        ...
        MonicoinTestFramework class so other tests can use it."""
