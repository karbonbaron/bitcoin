...
By default, monicoind will dump mempool on shutdown and
...
class MempoolPersistTest(MonicoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent monicoind from writing mempool.dat to disk. Verify that `savemempool` fails")
