...
// monicoin includes.
#include <..\src\script\monicoinconsensus.h>
...
int main()
{
    std::cout << "monicoinconsensus version: " << monicoinconsensus_version() << std::endl;
    ...
    auto op0Result = monicoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, monicoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
