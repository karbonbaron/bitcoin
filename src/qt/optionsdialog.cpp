    ...
    mapper(nullptr)
{
    ...
    ui->monicoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->monicoinAtStartup);
    ...
    ui->monicoinAtStartup->setToolTip(ui->monicoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->monicoinAtStartup->setText(ui->monicoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openMonicoinConfButton->setToolTip(ui->openMonicoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new MonicoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->monicoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openMonicoinConfButton_clicked()
{
