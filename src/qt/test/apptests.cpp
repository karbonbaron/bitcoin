...
//! Entry point for MonicoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &MonicoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for MonicoinGUI tests.
void AppTests::guiTests(MonicoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &MonicoinGUI::consoleShown, this, &AppTests::consoleTests);
