    ...
    platformStyle(_platformStyle)
{
    ...
    // normal monicoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying monicoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &MonicoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
