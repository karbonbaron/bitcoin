...
#ifndef MONICOIN_QT_GUIUTIL_H
#define MONICOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Monicoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "monicoin:" URI into recipient object, return true on successful parsing
