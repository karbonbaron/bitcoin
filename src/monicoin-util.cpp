...
static void SetupMonicoinUtilArgs(ArgsManager &argsman)
{
...
static int AppInitUtil(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " monicoin-util utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  monicoin-util [options] [commands]  Do stuff\n" +
            "\n";
