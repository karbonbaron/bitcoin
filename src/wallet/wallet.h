...
#ifndef MONICOIN_WALLET_WALLET_H
#define MONICOIN_WALLET_WALLET_H
...
public:
     ...
     * on this monicoin node, and set to 0 for transactions that were created
...
#endif // MONICOIN_WALLET_WALLET_H
