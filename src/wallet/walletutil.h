...
#ifndef MONICOIN_WALLET_WALLETUTIL_H
#define MONICOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! monicoin from opening the wallet, thinking it was newly created, and
...
#endif // MONICOIN_WALLET_WALLETUTIL_H
