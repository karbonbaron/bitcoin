...
#ifndef MONICOIN_WALLET_SCRIPTPUBKEYMAN_H
#define MONICOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Monicoin Core wallet was originally a collection of unrelated private
...
#endif // MONICOIN_WALLET_SCRIPTPUBKEYMAN_H
