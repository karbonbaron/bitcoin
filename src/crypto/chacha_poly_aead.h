...
#ifndef MONICOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define MONICOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@monicoin.
 *
 ...
 *
 * The chacha20-poly1305@monicoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@monicoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@monicoin are relatively fast in
...
#endif // MONICOIN_CRYPTO_CHACHA_POLY_AEAD_H
