...
#ifndef MONICOIN_SCRIPT_STANDARD_H
#define MONICOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a monicoin address
 */
...
/**
 * Generate a Monicoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // MONICOIN_SCRIPT_STANDARD_H
