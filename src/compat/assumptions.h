...
#ifndef MONICOIN_COMPAT_ASSUMPTIONS_H
#define MONICOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Monicoin cannot be compiled without assertions."
#endif
...
#endif // MONICOIN_COMPAT_ASSUMPTIONS_H
