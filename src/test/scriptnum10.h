...
#ifndef MONICOIN_TEST_SCRIPTNUM10_H
#define MONICOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Monicoin Core 0.10.0, for cross-comparison.
 */
public:
