...
Arguments:
    <base_directory> - The base directory of a monicoin source code repository.
...
Arguments:
    <file> - A source file in the monicoin repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Monicoin
