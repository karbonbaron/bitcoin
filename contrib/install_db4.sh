...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the monicoin repository."
  exit 1
fi
...
# See https://github.com/monicoin/monicoin/issues/16064
...
echo 'When compiling monicoind, run `./configure` in the following way:'
echo
