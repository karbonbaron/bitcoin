# Bootstrappable Monicoin Core Builds

This directory contains the files necessary to perform bootstrappable Monicoin
Core builds.
...
- 24GB of free disk space on the partition that the Monicoin Core git repository
  resides in
...
From the top of a clean Monicoin Core repository:
...
To use dongcarl's substitute server for Monicoin Core builds after having
